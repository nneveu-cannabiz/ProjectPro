...
interface StuckColumnProps {
  projects?: any[];
  onProjectClick?: (project: any) => void;
  onSprintReviewClick?: (project: any) => void;
}

const StuckColumn: React.FC<StuckColumnProps> = ({ projects = [], onProjectClick, onSprintReviewClick }) => {
  return (
    <div className="flex flex-col h-full">
      {/* Column Header */}
      <div className="rounded-t-lg border-t-8" style={{ borderTopColor: brandTheme.status.error }}>
        {/* Header Title */}
        <div 
        ...
        >
          <h3 className="text-lg font-bold text-white">Stuck/Need Help</h3>
        </div>
        {/* Project Count */}
        <div 
          className="px-4 py-2"
