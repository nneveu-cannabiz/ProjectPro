...
-- Create policies for authenticated users with safer approach
DO $$
BEGIN
    -- PMA_Projects policies
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Projects' AND policyname = 'Allow authenticated users to read projects'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Projects' AND policyname = 'Allow authenticated users to insert projects'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Projects' AND policyname = 'Allow authenticated users to update projects'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Projects' AND policyname = 'Allow authenticated users to delete projects'
    ) THEN
    ...
    -- PMA_Tasks policies
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Tasks' AND policyname = 'Allow authenticated users to read tasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Tasks' AND policyname = 'Allow authenticated users to insert tasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Tasks' AND policyname = 'Allow authenticated users to update tasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Tasks' AND policyname = 'Allow authenticated users to delete tasks'
    ) THEN
        CREATE POLICY "Allow authenticated users to delete tasks" ON "PMA_Tasks"
        FOR DELETE TO authenticated USING (true);
    END IF;

    -- PMA_SubTasks policies
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_SubTasks' AND policyname = 'Allow authenticated users to read subtasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_SubTasks' AND policyname = 'Allow authenticated users to insert subtasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_SubTasks' AND policyname = 'Allow authenticated users to update subtasks'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_SubTasks' AND policyname = 'Allow authenticated users to delete subtasks'
    ) THEN
        CREATE POLICY "Allow authenticated users to delete subtasks" ON "PMA_SubTasks"
        FOR DELETE TO authenticated USING (true);
    END IF;

    -- PMA_Updates policies
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Updates' AND policyname = 'Allow authenticated users to read updates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Updates' AND policyname = 'Allow authenticated users to insert updates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Updates' AND policyname = 'Allow authenticated users to update updates'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT FROM pg_policies WHERE tablename = 'PMA_Updates' AND policyname = 'Allow authenticated users to delete updates'
    ) THEN
